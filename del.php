      ...
      <div class="col-sm-12 well" style="background-color: white">
        <form>
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <label><h3><b>Contact Us</b></h3></label>
            </div>
          </div>
          ...
          <div class="row" >
            <div class="col-sm-1"></div>
            <div class="col-sm-10">
              <input type="text" name="" class="form-control" placeholder="Your Password" style="border-top: #0000;border-left: #0000;border-right: #0000; border-radius: 0px">
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-sm-1"></div>
            <div class="col-sm-10">
              <input type="text" name="" class="form-control" placeholder="Your Message" style="border-bottom: #0000;border-left: #0000;border-right: #0000; border-radius: 0px">
            </div>
          </div>
          ...
          <div class="row">
                      <div class="col-sm-1"></div>
                      <div class="col-sm-10">
                        <button class="btn btn-primary btn-block" style="border-radius: 20px">Submit</button>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                        <button class="btn btn-primary pull-right" style="border-radius: 20px;background: #3B5998;color:white;"><a href="#" class="fa fa-facebook"></a></button>
                      </div>

                      <div class="col-sm-3">
                        <button class="btn btn-primary pull-right" style="border-radius: 20px;background-color:white"></button>
                      </div>
